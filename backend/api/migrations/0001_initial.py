# Generated by Django 4.2.7 on 2024-10-14 20:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eamil', models.CharField(blank=True, max_length=100, null=True)),
                ('country', models.CharField(blank=True, max_length=100, null=True)),
                ('stripe_seesion_id', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart_order_item_id', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=6, max_length=20, prefix='', unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
            ],
            options={
                'ordering': ['-date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('English', 'English'), ('French', 'French'), ('Spanish', 'Spanish'), ('Arabic', 'Arabic')], default='English', max_length=100)),
                ('level', models.CharField(choices=[('Beginer', 'Beginer'), ('Intermediate', 'Intermediate'), ('Advanced', 'Advanced')], default='Beginer', max_length=100)),
                ('platform_course_status', models.CharField(choices=[('Review', 'Review'), ('Disabled', 'Disabled'), ('Rejected', 'Rejected'), ('Approved', 'Approved')], default='Review', max_length=100)),
                ('teacher_course_status', models.CharField(choices=[('Draft', 'Draft'), ('Disabled', 'Disabled'), ('Published', 'Published')], default='draft', max_length=100)),
