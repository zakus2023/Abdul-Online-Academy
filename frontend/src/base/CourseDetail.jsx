              ...
              <div className="container">
                <div className="row py-5">
                  <div className="col-lg-8">
                    ...
                    {/* Note this well: dangerouslySetInnerHTML={{__html: `${course?.description?.slice(0, 200)}`}} added  */}
                    <p
                      className="mb-3"
                    ...
                    <ul className="list-inline mb-0">
                      ...
                      <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                        ...
                        {/* make sure to import moment at the top */}
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <span className="small ms-0 ms-sm-2">
                                        ({c.variant_items?.length} Lectures)
                                      </span>
                                    </button>
                                  </h6>
                                  <div
                          ...
                          >
                            ...
                            <div className="row">
                              {reviews?.map((review, i) => (
                                <div className="d-md-flex my-4" key={i}>
