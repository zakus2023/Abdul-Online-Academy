      ...
      <div className="container mt-lg-2">
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            {/* about company */}
            <div className="mb-4">
              <h1>Abdul Online Learning</h1>
              <div className="mt-4">
                <p>
                Abdul Online Learning offers a diverse range of courses, 
                allowing you to learn at your own pace. With engaging video lessons 
                and expert instructors, you can explore subjects from technology to 
                personal development. Join us to unlock new skills 
                and enhance your knowledge anytime, anywhere!
                </p>
                {/* social media */}
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p>126795 Southgate Rd 12 Dundalk ON, N0C 1B0, Canada</p>
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> support@abdulonlinelearnining.com</a>
              </p>
              <p>
                Phone:
                <span className="text-light fw-semibold"> +1 647 619 2144</span>
              </p>
        ...
        <div className="row align-items-center g-0 border-top py-2 mt-6">
          ...
          <div className="col-md-10 col-12">
            <div className="d-lg-flex align-items-center">
              <div className="me-4">
                <span>
                  ©{currentYear}@<span id="copyright5"></span>
                  AbdulOnline Learning
                </span>
              </div>
              <div>
